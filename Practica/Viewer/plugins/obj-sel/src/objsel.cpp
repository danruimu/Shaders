...
ObjSel::ObjSel() : pmouseAction(NONE)
{}

void ObjSel::mousePressEvent( QMouseEvent *e)
{
    pxClick = e->x();
    pyClick = e->y();
...
void ObjSel::mouseReleaseEvent( QMouseEvent *)
{
    pmouseAction = NONE;
}

void ObjSel::mouseMoveEvent(QMouseEvent *e)
{ 
